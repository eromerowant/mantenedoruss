...
return [
    ...
    */
    ...
    'exists_soft'          => 'El campo :attribute seleccionado no existe.',
    ...
    */
    ...
    'attributes' => [
        ...
        'title_info'    => 'título en la información',
        'text_info'     => 'texto en la información',
        'image_file'    => 'archivo de imágen',
        'title'         => 'título',
        'video_portada' => 'video de portada',
        'birthday'      => 'cumpleaños',
        'theme'         => 'tema',
        'type'          => 'tipo',
        'age'           => 'edad',
